...
function updateQuantity(itemId, itemType, action) {
    ...
    .then(data => {
        if (data.success) {
            ...
            showErrorNotification(data.message || 'Erro ao atualizar quantidade');
        }
    })
    .catch(error => {
        console.error('Error:', error);
        showErrorNotification('Erro ao atualizar quantidade');
    });
}
...
function removeFromCart(itemId, itemType) {
    ...
    .then(data => {
        if (data.success) {
            ...
            showErrorNotification(data.message || 'Erro ao remover item');
        }
    })
    .catch(error => {
        console.error('Error:', error);
        showErrorNotification('Erro ao remover item');
    });
}
</script>
